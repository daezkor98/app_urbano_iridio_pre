...
//        loadDatos();
    ...
    public boolean validateRutaDelDiaIniciado() {
        ...
        for (com.urbanoexpress.iridio3.model.entity.EstadoRuta estado : estadoRuta) {
            if (estado.getEstado() == com.urbanoexpress.iridio3.model.entity.EstadoRuta.Estado.INICIADO) {
                Log.d(TAG, "ruta del dia: true");
                validate = true;
            }
            if (estado.getEstado() == com.urbanoexpress.iridio3.model.entity.EstadoRuta.Estado.FINALIZADO) {
