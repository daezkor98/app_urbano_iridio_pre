...
import com.urbanoexpress.iridio3.pre.view.RecoleccionSellerView;
...
import static com.urbanoexpress.iridio3.pre.ui.model.PiezaRecolectadaItem.Type;

public class RecoleccionSellerPresenter {

    private static final String TAG = RecoleccionSellerPresenter.class.getSimpleName();

    private RecoleccionSellerView view;
    ...
    public RecoleccionSellerPresenter(RecoleccionSellerView view, ArrayList<Ruta> rutas,
