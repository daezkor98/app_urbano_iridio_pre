package com.urbanoexpress.iridio3.pre.util.components.searchview;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private View mSuggestionLineTop;
    private ListView mSuggestionsListView;
    private EditText mSearchSrcTextView;
    private ImageButton mBackBtn;
    private ImageButton mVoiceBtn;
    private ImageButton mScanBarcodeBtn;
    ...
    private void initiateView() {
        ...
        mSearchContentLayout = findViewById(R.id.search_content_layout);
        ...
        mScanBarcodeBtn = (ImageButton) mSearchLayout.findViewById(R.id.action_scan_btn);
        mEmptyBtn = (ImageButton) mSearchLayout.findViewById(R.id.action_empty_btn);
        mTintView = mSearchLayout.findViewById(R.id.transparent_view);
        mSuggestionLineTop = mSearchLayout.findViewById(R.id.suggestion_line_top);

        mSearchSrcTextView.setOnClickListener(mOnClickListener);
        mBackBtn.setOnClickListener(mOnClickListener);
        mVoiceBtn.setOnClickListener(mOnClickListener);
        mScanBarcodeBtn.setOnClickListener(mOnClickListener);
    ...
    private void initSearchView() {
        ...
        mSearchSrcTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.toString().isEmpty()) {
                    mScanBarcodeBtn.setVisibility(VISIBLE);
                } else {
                    mScanBarcodeBtn.setVisibility(GONE);
                }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ((FrameLayout) mSearchLayout).getLayoutTransition()
    ...
    private final OnClickListener mOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == mBackBtn) {
                ...
                onVoiceClicked();
            } else if (v == mScanBarcodeBtn) {
                closeSearch();
                mSearchViewActionListener.onActionScanBarcode();
            } else if (v == mEmptyBtn) {
    ...
    /**
     * Call this method to show suggestions list. This shows up when adapter is set. Call {@link #setAdapter()} before calling this.
     */
    ...
    public void setAdapter() {
        Log.d("MaterialSearchView", "setAdapter()");
        mSuggestionsListView.setAdapter(mAdapter);
        if (!mSearchSrcTextView.getText().toString().isEmpty()) {
...
//        if (suggestions != null && suggestions.length > 0) {
        if (suggestions != null) {
            ...
            mAdapter = new SearchAdapter(mContext, suggestions, suggestionIcon, ellipsize);
//            setAdapter(adapter);
    ...
    public void dismissSuggestions() {
        SearchAdapter adapter = new SearchAdapter(mContext, new String[]{}, suggestionIcon, ellipsize);
        mSuggestionsListView.setAdapter(adapter);
        mSuggestionLineTop.setVisibility(INVISIBLE);
...
//        }
    ...
    private void setVisibleWithAnimation() {
        AnimationUtil.AnimationListener animationListener = new AnimationUtil.AnimationListener() {
            ...
            public boolean onAnimationEnd(View view) {
                Log.d("MaterialSearchView", "onAnimationEnd()");
                setBackgroundSearchTopBarWithSuggestion();
                setAdapter();
                if (mSearchViewListener != null) {
                    mSearchViewListener.onSearchViewShown();
                }
    ...
    private void setBackgroundSearchTopBarWithSuggestion() {
        if (mAdapter != null && mAdapter.getCount() != 0) {
            mSearchTopBar.setBackgroundResource(R.drawable.bg_search_view_with_suggestion);
            mSuggestionLineTop.setVisibility(VISIBLE);
        }
    }
...
//        setHideSuggestionLayoutWithAnimation();
...
//        }
    ...
    private void setHideWithAnimation() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            int startRadius = Math.max(mSearchTopBar.getWidth(), mSearchTopBar.getHeight());
            AnimationUtil.hide(mSearchContentLayout, cx, cy, startRadius, 0,animationListener);
        } else {
            AnimationUtil.fadeOutView(mSearchLayout, mAnimationDuration, animationListener);
        }
    }

//    private void setHideSuggestionLayoutWithAnimation() {
//        AnimationUtil.AnimationListener animationListener = new AnimationUtil.AnimationListener() {
//            @Override
//            public boolean onAnimationStart(View view) {
//                return false;
...
//            int cx = mSearchTopBar.getWidth() - (int) TypedValue.applyDimension(
//                    TypedValue.COMPLEX_UNIT_DIP, 24, mSearchTopBar.getResources().getDisplayMetrics());
//            int cy = (int) mSearchTopBar.getY();
//            int startRadius = Math.max(mSearchTopBar.getWidth(), mSearchTopBar.getHeight());
//            int endRadius = (int) TypedValue.applyDimension(
//                    TypedValue.COMPLEX_UNIT_DIP, 24, mSearchTopBar.getResources().getDisplayMetrics());
//            AnimationUtil.hide(mSuggestionLayout, cx, cy, startRadius, endRadius, animationListener);
//        } else {
//            AnimationUtil.fadeOutView(mSuggestionLayout, mAnimationDuration, animationListener);
//        }
//    }
    ...
    /**
     * Set this listener to listen to Search View Action events
     *
     * @param listener
     */
    public void setOnSearchViewActionListener(SearchViewActionListener listener) {
        mSearchViewActionListener = listener;
    }
