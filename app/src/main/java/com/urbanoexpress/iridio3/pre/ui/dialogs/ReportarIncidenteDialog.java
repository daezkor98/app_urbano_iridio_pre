...
import com.urbanoexpress.iridio3.pre.databinding.ModalReportarIncidenteBinding;
import com.urbanoexpress.iridio3.pre.presenter.ReportarIncidentePresenter;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (!isAdded() || getActivity() == null) {
            com.google.firebase.crashlytics.FirebaseCrashlytics.getInstance().recordException(
                new IllegalStateException("ReportarIncidenteDialog.onActivityResult: dialog detached, requestCode=" + requestCode));
            return;
        }
        Log.d(TAG, "RESULT");
        try {
