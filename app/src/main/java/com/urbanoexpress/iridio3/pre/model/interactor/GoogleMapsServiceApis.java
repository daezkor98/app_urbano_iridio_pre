...
public class GoogleMapsServiceApis {
    ...
    public static void distanceMatrix(String[] params, final RequestCallback callback) {
        ...
        ApiService.getInstance().putParams("origins", params[0]);
        ApiService.getInstance().putParams("destinations", params[1]);
    ...
    public static void geocoding(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("address", params[0]);
        ApiService.getInstance().request(ApiRest.getInstance().getApiBaseUrl() +
