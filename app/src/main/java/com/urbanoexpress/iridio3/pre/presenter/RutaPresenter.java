...
import com.urbanoexpress.iridio3.pre.ui.MapaRutaDelDiaActivity;
import com.urbanoexpress.iridio3.pre.ui.RutaActivity;
import com.urbanoexpress.iridio3.pre.ui.TransferirGuiaActivity;
import com.urbanoexpress.iridio3.pre.ui.adapter.ManifiestoAdapter;
import com.urbanoexpress.iridio3.pre.ui.dialogs.AsignarRutaDialog;
import com.urbanoexpress.iridio3.pre.ui.dialogs.CodigoQRRutaDialog;
import com.urbanoexpress.iridio3.pre.ui.dialogs.EditarPlacaDialog;
...
import com.urbanoexpress.iridio3.pre.ui.model.ManifiestoItem;
...
public class RutaPresenter extends BaseModalsView implements OnClickItemListener {
    ...
    public void onActionTransferirGuias() {
        if(Session.getUser().getFlag().equals("1")){
            ...
            showToast(view.getContextView(),
                    "Solo el auxiliar puede realizar la transferencia de guías.",
                    Toast.LENGTH_LONG);
        }
