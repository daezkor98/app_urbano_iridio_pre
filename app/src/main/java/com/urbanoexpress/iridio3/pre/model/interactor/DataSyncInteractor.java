...
import com.urbanoexpress.iridio3.pre.model.entity.RutaEliminada;
...
//    }
    ...
    public static void uploadGuiaGestionada(String[] params, final RequestCallback callback) {
        ApiService.getInstance()
                .putNewParams(new HashMap<String, String>() {{
                    put("vp_doc_id", params[0]);
                    put("vp_mot_id", params[1]);
                    put("vp_fecha", params[2]);
                    put("vp_hora", params[3]);
                    put("vp_doc_px", params[4]);
                    put("vp_doc_py", params[5]);
                    put("vp_nombre", params[6]);
                    put("vp_nro_dni", params[7]);
                    put("vp_num_pos", params[8]);
                    put("vp_piezas", params[9]);
                    put("vp_peso", params[10]);
                    put("vp_guia_electronica", params[11]);
                    put("vp_comentario", params[12]);
                    put("vp_intento", params[13]);
                    put("vp_recoleccion", params[14]);
                    put("vp_tipo_zona", params[15]);
                    put("vp_tipo_guia", params[16]);
                    put("vp_tipo_direccion", params[17]);
                    put("vp_tipo_medio_pago", params[18]);
                    put("vp_mot_id_obs_entrega", params[19]);
                    put("vp_comentario_obs_entrega", params[20]);
                    put("vp_linea_negocio", params[21]);
                    put("vp_user", params[22]);
                    put("vp_id_mac", params[23]);
                    put("flag", params[24]);
                }})
                .requestForm(ApiRest.Api.UPLOAD_GUIA_GESTIONADA_V2, new ApiService.ResponseListener() {
                    @Override
                    public void onResponse(JSONObject response) {
                        callback.onSuccess(response);
                    }
...
//    }
    ...
    public void uploadImagenDescarga(String[] params, MultipartJsonObjectRequest.DataPart data,
        ...
        ApiService.getInstance().putParams("vp_doc_id", params[0]);
        ApiService.getInstance().putParams("vp_imagen", params[1]);
        ApiService.getInstance().putParams("vp_tipo", params[2]);
        ApiService.getInstance().putParams("vp_fecha", params[3]);
        ApiService.getInstance().putParams("vp_hora", params[4]);
        ApiService.getInstance().putParams("vp_img_px", params[5]);
        ApiService.getInstance().putParams("vp_img_py", params[6]);
        ApiService.getInstance().putParams("id_user", params[7]);
        ApiService.getInstance().putParams("id_servicios_adjuntos", params[8]);
        ApiService.getInstance().putParams("vp_linea_negocio", params[9]);
        ApiService.getInstance().putData("uploadedfile", data);

        ApiService.getInstance().request(
                ApiRest.getInstance().getApiBaseUrl() + ApiRest.Api.UPLOAD_IMAGEN,
...
//    }
    ...
    public void uploadImagenParadaProgramada(String[] params, MultipartJsonObjectRequest.DataPart data,
                                     final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_id_parada", params[0]);
        ApiService.getInstance().putParams("vp_imagen", params[1]);
        ApiService.getInstance().putParams("vp_tipo", params[2]);
        ApiService.getInstance().putParams("vp_fecha", params[3]);
        ApiService.getInstance().putParams("vp_hora", params[4]);
        ...
        ApiService.getInstance().request(
                ApiRest.getInstance().getApiBaseUrl() + ApiRest.Api.UPLOAD_IMAGEN_PARADA_PROGRAMADA,
                ApiService.TypeParams.MULTIPART,
                new ApiService.ResponseListener() {
                    @Override
                    public void onResponse(org.json.JSONObject response) {
    ...
    public void uploadIncidenteRuta(String[] params, MultipartJsonObjectRequest.DataPart data,
                                    final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_id_ruta", params[0]);
        ApiService.getInstance().putParams("vp_id_mot_incidente", params[1]);
        ApiService.getInstance().putParams("vp_imagen", params[2]);
        ApiService.getInstance().putParams("vp_tipo", params[3]);
        ApiService.getInstance().putParams("vp_fecha", params[4]);
        ApiService.getInstance().putParams("vp_hora", params[5]);
        ApiService.getInstance().putParams("vp_comentarios", params[6]);
        ApiService.getInstance().putParams("vp_px", params[7]);
        ApiService.getInstance().putParams("vp_py", params[8]);
        ApiService.getInstance().putParams("vp_linea_negocio", params[9]);
        ApiService.getInstance().putParams("vp_id_user", params[10]);
        ApiService.getInstance().putParams("vp_id_mac", params[11]);
        ApiService.getInstance().putData("uploadedfile", data);
        ApiService.getInstance().request(ApiRest.getInstance().getApiBaseUrl() +
                        ApiRest.Api.UPLOAD_INCIDENTE_RUTA,
                ApiService.TypeParams.MULTIPART, new ApiService.ResponseListener() {
                    @Override
                    public void onResponse(JSONObject response) {
                        callback.onSuccess(response);
                    }
...
//        ApiService.getInstance()
//                .putNewParams(new HashMap<String, String>() {{
//                    put("vp_gps_tracking", params[0]);
//                    put("vp_id_mac", params[1]);
//                    put("vp_id_user", params[2]);
//                }})
//                .requestForm(ApiRest.Api.UPLOAD_GPS, new ApiService.ResponseListener() {
//                    @Override
//                    public void onResponse(JSONObject response) {
//                        callback.onSuccess(response);
//                    }
...
//    }
    ...
    public static void uploadTrackLocation(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_gps_tracking", params[0]);
...
//    public static void uploadSecuenciaRuta(String[] params, Context context, final RequestCallback callback) {
//        String url = ApiRest.getInstance().getApiBaseUrlV2() + ApiRest.Api.UPLOAD_SECUENCIA_RUTA_V2;
//
//        JSONObject jsonBody = new JSONObject();
//        try {
//            JSONArray secuenciaArray = new JSONArray(params[0]);
//
//            jsonBody.put("vp_secuencia", secuenciaArray);
//            jsonBody.put("vp_segundos", params[1]);
//            jsonBody.put("vp_metros", params[2]);
//            jsonBody.put("vp_imei_cel", params[3]);
//            jsonBody.put("vp_user", params[4]);
//            jsonBody.put("flag", params[5]);
...
//    public static void uploadSecuenciaRuta(String[] params, final RequestCallback callback) {
//        try {
//            JSONArray secuenciaArray = new JSONArray(params[0]);
//            JSONObject jsonBody = new JSONObject();
//
...
//            ApiService.getInstance()
//                    .requestJSon(
//                            ApiRest.Api.UPLOAD_SECUENCIA_RUTA_V2,
...
//        } catch (JSONException e) {
//            e.printStackTrace();
//            callback.onError(new VolleyError("Error creating JSON: " + e.getMessage()));
//        }
//    }

    public void uploadSecuenciaRuta(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_secuencia", params[0]);
        ApiService.getInstance().putParams("vp_segundos", params[1]);
        ApiService.getInstance().putParams("vp_metros", params[2]);
        ApiService.getInstance().putParams("vp_imei_cel", params[3]);
        ApiService.getInstance().putParams("vp_user", params[4]);
        ApiService.getInstance().putParams("flag", params[5]);
        ApiService.getInstance().request(ApiRest.getInstance().getApiBaseUrl() +
                        ApiRest.Api.UPLOAD_SECUENCIA_RUTA_V2,
                ApiService.TypeParams.FORM_DATA, new ApiService.ResponseListener() {
                    @Override
    ...
    public void uploadGestionLlamada(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_gestion_llamadas", params[0]);
        ApiService.getInstance().putParams("vp_id_mac", params[1]);
        ApiService.getInstance().putParams("vp_id_user", params[2]);
        ApiService.getInstance().request(ApiRest.getInstance().getApiBaseUrl() +
    ...
    public void syncNuevasGuias(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_id_ruta", params[0]);
        ApiService.getInstance().putParams("imei", params[1]);
        ApiService.getInstance().putParams("guias", params[2]);
        ApiService.getInstance().putParams("linea_valores", params[3]);
        ApiService.getInstance().putParams("linea_logistica", params[4]);
        ApiService.getInstance().putParams("id_user", params[5]);
        ApiService.getInstance().request(ApiRest.getInstance().getApiBaseUrl() +
    ...
    public List<SecuenciaRuta> selectAllSecuenciaRuta() {
        List<SecuenciaRuta> all = SecuenciaRuta.listAll(SecuenciaRuta.class);
