...
import com.urbanoexpress.iridio3.pre.util.constant.DriverVerificationConstants.ERROR_400
import com.urbanoexpress.iridio3.pre.util.constant.DriverVerificationConstants.ERROR_MSG
import com.urbanoexpress.iridio3.pre.util.constant.DriverVerificationConstants.GENERIC_ERROR
import com.urbanoexpress.iridio3.pre.util.constant.DriverVerificationConstants.RESPONSE_ERROR
import com.urbanoexpress.iridio3.pre.util.constant.DriverVerificationConstants.SUCCESS
    ...
    suspend fun loginQResponse(idRuta: String, verificationCode: String): JSONObject =
        suspendCoroutine { continuation ->
            ...
            val jsonObjectRequest = JsonObjectRequest(Request.Method.POST,
                ApiRest.getInstance().apiBaseUrl + ApiRest.Api.LOGIN_QR + idRuta + "/${verificationCode}",
                null,
                { response ->
