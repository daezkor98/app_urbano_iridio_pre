...
import static com.urbanoexpress.iridio3.pre.data.rest.ApiRest.Api.GUIA_YAPE_QR;
...
//                .getInstance()
//                .putNewParams(params)
//                .requestForm(GUIA_YAPE_QR, new ApiService.ResponseListener() {
//                    @Override
...
//    }
    ...
    public void getQuiaYapeQR(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_man_id_det", params[0]);
        ApiService.getInstance().request("https://pyp3.dev-urbano.dev/api-apps/iridio/getGuiasRutaQR",
    ...
    public void getRutas(String[] params, final RequestCallback callback) {
        ...
        ApiRequest.getInstance().requestJSon(ApiRest.getInstance().getApiBaseUrl() +
...
//                    put("vp_id_ruta", params[0]);
//                    put("id_user", params[1]);
//                    put("imei", params[2]);
//                    put("flag", params[3]);
//                }})
//                .requestForm(ApiRest.Api.GET_RUTAS_V2, new ApiService.ResponseListener() {
//                    @Override
//                    public void onResponse(JSONObject response) {
//                        callback.onSuccess(response);
//                    }
...
//    }
    ...
    public void getGuiasRutaRural(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("linea_logistica", params[0]);
    ...
    public void getMotivos(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_chk_id", params[0]);
        ApiService.getInstance().putParams("id_user", params[1]);
        ApiService.getInstance().request(ApiRest.getInstance().getApiBaseUrl() +
    ...
    public static void editPlaca(String[] params, final RequestCallback callback) {
        ...
        ApiService.getInstance().putParams("vp_id_user", params[3]);
        ApiService.getInstance().request(ApiRest.getInstance().getApiBaseUrl() +
    ...
    public static void getGuiasElectronicasRecoleccion(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_id_recoleccion", params[0]);
...
//    }
    ...
    public static void uploadEstadoRutaKilometraje(String[] params, final RequestCallback callback) {
        ApiService.getInstance()
                .putNewParams(new HashMap<String, String>() {{
                    put("vp_rou_id", params[0]);
                    put("vp_rou_estado", params[1]);
                    put("vp_gps_px", params[2]);
                    put("vp_gps_py", params[3]);
                    put("vp_fecha", params[4]);
                    put("vp_hora", params[5]);
                    put("vp_km", params[6]);
                    put("vp_linea_negocio", params[7]);
                    put("firebaseToken", params[8]);
                    put("motivo_nt", params[9]);
                    put("id_user", params[10]);
                    put("imei", params[11]);
                    put("flag", params[12]);
                }})
                .requestForm(ApiRest.Api.UPLOAD_ESTADO_RUTA_KILOMETRAJE_V2, new ApiService.ResponseListener() {
                    @Override
                    public void onResponse(JSONObject response) {
                        callback.onSuccess(response);
                    }
...
//    }
    ...
    public static void validateSolicitaKilometraje(String[] params, final RequestCallback callback) {
        ApiService.getInstance().newParams();
        ApiService.getInstance().putParams("vp_rutas", params[0]);
    ...
    public static void readBarraRecoleccion(String[] params, final RequestCallback callback) {
        ...
        ApiService.getInstance().putParams("vp_srec_id", params[1]);
        ApiService.getInstance().putParams("vp_id_user", params[2]);
        ApiService.getInstance().request(ApiRest.getInstance().getApiBaseUrl() +
