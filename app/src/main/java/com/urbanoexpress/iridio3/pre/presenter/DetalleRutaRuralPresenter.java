...
import com.urbanoexpress.iridio3.pre.presenter.helpers.ShowDescargaRutaHelper;
import com.urbanoexpress.iridio3.pre.ui.dialogs.DetalleRequerimientoGuiaBottomSheet;
import com.urbanoexpress.iridio3.pre.ui.dialogs.GaleriaGEDialog;
import com.urbanoexpress.iridio3.pre.ui.dialogs.GestionDevolucionGuiaBottomSheet;
import com.urbanoexpress.iridio3.pre.ui.dialogs.PiezasGuiaBottomSheet;
import com.urbanoexpress.iridio3.pre.ui.dialogs.RecolectaGEDialog;
import com.urbanoexpress.iridio3.pre.ui.dialogs.TelefonosGuiaBottomSheet;
...
import com.urbanoexpress.iridio3.pre.view.DetalleRutaRuralView;
                ...
                case 2:
                    ...
                    if(guiaGestionada != null){
                        if (ModelUtils.isGuiaRecoleccion(ruta.getTipo()) &&
                                !guiaGestionada.getGuiaElectronica().isEmpty()) {
                            CommonUtils.setVisibilityOptionMenu(view.getMenuToolbar(),
