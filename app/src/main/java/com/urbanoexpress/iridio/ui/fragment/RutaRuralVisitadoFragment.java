...
import com.urbanoexpress.iridio.databinding.FragmentRutasBinding;
import com.urbanoexpress.iridio.presenter.RutaRuralVisitadoPresenter;
...
import com.urbanoexpress.iridio.view.RutaGestionadaView;

import java.util.List;

public class RutaRuralVisitadoFragment extends Fragment implements RutaGestionadaView,
        RutaAdapter.OnClickGuiaItemListener {

    private FragmentRutasBinding binding;
    private RutaRuralVisitadoPresenter presenter;

    public RutaRuralVisitadoFragment() {}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (presenter == null) {
            presenter = new RutaRuralVisitadoPresenter(this);
        }
