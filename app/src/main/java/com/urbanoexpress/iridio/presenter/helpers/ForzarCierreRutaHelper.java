...
import com.urbanoexpress.iridio.databinding.ModalInputClaveForzarCierreRutaBinding;
...
public class ForzarCierreRutaHelper {
    ...
    public static void deleteAllDataRuta(Context context) {
        ...
        File file = new File(com.urbanoexpress.iridio.util.FileUtils.getBaseDirectoryPath(context));
