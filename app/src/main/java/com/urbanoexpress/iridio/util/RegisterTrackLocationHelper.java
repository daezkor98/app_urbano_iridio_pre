...
//        loadDatos();
    ...
    public boolean validateRutaDelDiaIniciado() {
        ...
        for (com.urbanoexpress.iridio.model.entity.EstadoRuta estado : estadoRuta) {
            if (estado.getEstado() == com.urbanoexpress.iridio.model.entity.EstadoRuta.Estado.INICIADO) {
                Log.d(TAG, "ruta del dia: true");
                validate = true;
            }
            if (estado.getEstado() == com.urbanoexpress.iridio.model.entity.EstadoRuta.Estado.FINALIZADO) {
