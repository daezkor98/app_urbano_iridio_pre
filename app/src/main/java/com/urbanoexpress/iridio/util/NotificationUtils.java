...
public class NotificationUtils extends ContextWrapper {
    ...
    public static final String DATA_SYNC_CHANNEL_ID                 = "com.urbanoexpress.iridio.channel.id.DATA_SYNC";

    public static final String GENERAL_NOTIFICATIONS_CHANNEL_ID     = "com.urbanoexpress.iridio.channel.id.GENERAL_NOTIFICATIONS";

    public static final String NEW_ROUTES_CHANNEL_ID                = "com.urbanoexpress.iridio.channel.id.NEW_ROUTES";

    public static final String ROUTES_NOTIFICATIONS_CHANNEL_ID      = "com.urbanoexpress.iridio.channel.id.ROUTES_NOTIFICATIONS";
